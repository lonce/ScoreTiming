...
from modules.midiscoretools import midi_to_bitmap, extract_time_signatures, count_total_ticks, Frame, loadBitmap
from modules.midiscoretools import time2tick, tick2time, ticks_per_beat_at_tick, beats_per_measure_at_tick
...
def main():
	...
	###############################################
	# Assuming 'matrix' is your original numpy array
	saveBitmap(args.outputbitmap,bitmap )
